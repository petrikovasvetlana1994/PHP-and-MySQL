...
[
        ...
        'date1' => 'Январь 2022',
        'date2' => 'Текущее время',
        'description' => 'Стараюсь быть добрым с подчиненными. Иногда без спроса беру конфеты у своего помощника и угощаю ими менеджера.',
    ],
    [
        'name' => 'Помощник руководителя отдела',
        'date1' => 'Июнь 2020',
        'date2' => 'Декабрь 2021',
        'description' => 'Туда-сюда уже не бегал. Ругал менеджера. Руководитель был добрым, но постоянно куда-то пропадали мои конфеты.',
    ],
    [
        'name' => 'Менеджер',
        'date1' => 'Февраль 2017',
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]["date1"]; ?> - <?php echo $experience[$i]["date2"]; ?></h6>
